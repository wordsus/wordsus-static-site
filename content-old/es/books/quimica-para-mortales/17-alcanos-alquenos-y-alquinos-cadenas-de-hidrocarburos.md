*Exploramos los hidrocarburos más simples, analizando las diferencias de reactividad entre enlaces simples, dobles y triples que sostienen a esta industria.*

---

Si miras a tu alrededor en este preciso momento, es casi seguro que estés rodeado de ellos. El plástico de la pantalla o teclado que estás utilizando, la ropa que llevas puesta, el combustible que moviliza el transporte público o tu vehículo particular, el asfalto de las calles, las velas de un pastel de cumpleaños, e incluso los componentes de los medicamentos que guardas en tu botiquín. Todos estos elementos, tan dispares en su apariencia y función, comparten un origen común y una estructura fundamental asombrosamente simple. Están hechos de esqueletos moleculares, cadenas de átomos que se toman de las manos para construir la inmensa diversidad del mundo moderno.
...
## 1. El protagonista indiscutido: El átomo de carbono
...
Dependiendo de cómo los átomos de carbono decidan usar sus manos entre ellos, se formarán las tres grandes familias que hoy nos convocan.

## 2. Alcanos: Los cimientos tranquilos de la química

Comenzamos nuestro viaje con la familia más relajada, estable y, en términos químicos, "aburrida" de los hidrocarburos. Los **alcanos** son hidrocarburos de cadena abierta donde todos los enlaces entre los átomos de carbono son **enlaces simples**.

¿Qué significa esto en nuestra analogía? Significa que un átomo de carbono se toma de una sola mano con su carbono vecino. Esto le deja otras tres manos libres para unirse a átomos de hidrógeno (o a otros carbonos si la cadena continúa). Debido a que están repletos de hidrógeno hasta su máxima capacidad posible, a los alcanos se los conoce como hidrocarburos **saturados**. Literalmente, no hay espacio para acomodar ni un solo hidrógeno más en la molécula sin romper un enlace de carbono.

### La matemática de los alcanos

La química es una ciencia exacta, y la estructura de los alcanos sigue una progresión matemática impecable. Si conoces el número de átomos de carbono en un alcano, puedes predecir exactamente cuántos átomos de hidrógeno tendrá utilizando su fórmula general:

$$ C_n H_{2n+2} $$

Donde $n$ es el número de átomos de carbono.
Si tenemos un alcano con 3 carbonos ($n=3$), el número de hidrógenos será $2(3) + 2 = 8$. La fórmula es $C_3H_8$ (este es el famoso gas propano).
...
Por cada enlace doble que se forma, la molécula pierde dos átomos de hidrógeno respecto a su alcano correspondiente. La fórmula general para un alqueno con un solo enlace doble es:

$$ C_n H_{2n} $$

Si tenemos un alqueno con 2 carbonos ($n=2$), los hidrógenos serán 4. La fórmula es $C_2H_4$. Este es el alqueno más simple, el **eteno** (o etileno).
...
## 4. Alquinos: Energía pura y contenida

Llegamos a los extremos del estrés molecular: los **alquinos**. Esta es la segunda familia de hidrocarburos insaturados, y se define por la presencia de al menos un **enlace triple** entre dos átomos de carbono.

Nuestros dos átomos de carbono han decidido entrelazarse fuertemente usando tres de sus cuatro manos. Esto deja a cada uno con una sola y solitaria mano libre para unirse al exterior.

### La matemática de los alquinos

La fórmula general para un alquino con un enlace triple sufre una reducción aún mayor de hidrógenos:

$$ C_n H_{2n-2} $$

El alquino más pequeño posible requiere dos carbonos ($n=2$). Sus hidrógenos serán $2(2) - 2 = 2$. La fórmula es $C_2H_2$. Se trata del **etino**, comúnmente conocido en la industria como acetileno.
...
### El fuego purificador: Uso industrial

Esa tensión concentrada en el enlace triple hace que los alquinos sean moléculas extremadamente reactivas y, bajo ciertas condiciones, inestables. Mientras que un alcano requiere energía para iniciar su combustión, los alquinos están esperando cualquier excusa para liberar toda esa energía almacenada en el enlace triple.

El uso estelar del acetileno ($C_2H_2$) es en la **soldadura y corte oxiacetilénico**. Cuando el gas acetileno se mezcla con oxígeno puro y se enciende, la ruptura de esos enlaces triples libera una cantidad de calor tan bestial que la llama alcanza temperaturas superiores a los **3,000 °C**. Es una de las llamas químicas más calientes conocidas por el hombre, capaz de derretir y cortar acero grueso como si fuera mantequilla a temperatura ambiente.

Curiosamente, a pesar de su agresividad energética, también encontramos alquinos en la naturaleza y en la industria farmacéutica. Muchos medicamentos modernos contra el cáncer, o componentes de píldoras anticonceptivas, contienen enlaces triples estratégicamente ubicados porque su forma lineal rígida encaja perfectamente en ciertos receptores celulares de nuestro cuerpo.

## 5. La batalla de la reactividad: Simples vs. Dobles vs. Triples
...
-------------------------------------------------------------------
Fuerza Total         | Alta         | Muy Alta     | Máxima
Distancia entre C    | 154 pm       | 134 pm       | 120 pm
Reactividad química  | Muy Baja     | Alta         | Muy Alta
...
## 6. El idioma de los químicos: Nomenclatura básica
...
## 7. Isomería: El arte de reordenar las piezas

Hasta ahora hemos visto cadenas lineales, como un collar de perlas. Pero el carbono es creativo. A medida que sumamos carbonos, empezamos a tener diferentes formas de conectar las *mismas* piezas. A esto se le llama **isomería estructural**. Los isómeros son moléculas que tienen la *misma fórmula molecular* (misma cantidad de átomos), pero *diferente estructura* y, por ende, diferentes propiedades.
...
Como regla general: cuanto más corta es la cadena de carbonos, más liviana es la molécula, menos se "pega" a sus vecinas, y más fácilmente se evapora (punto de ebullición bajo). Cuanto más larga es la cadena, más pesada es, y más calor necesita para volverse gas.
...
```text
  [Salida Superior: < 40 °C]  ----> GASES (Metano, Etano, Propano, Butano)
         ...
         | 
  [Platos: ~ 40 - 200 °C]     ----> GASOLINAS Y NAFTAS
         ^                            (5 a 10 carbonos. Automóviles y petroquímica)
         |
  [Platos: ~ 200 - 300 °C]    ----> QUEROSENO Y COMBUSTIBLE DE AVIACIÓN
         ^                            (11 a 16 carbonos. Aviones y estufas)
         |
  [Platos: ~ 300 - 370 °C]    ----> GASOIL / DIÉSEL
         ^                            (16 a 25 carbonos. Camiones y maquinaria)
         |
  [Salida Inferior: > 370 °C] ----> RESIDUOS LÍQUIDOS Y SÓLIDOS
                                      (> 25 carbonos. Aceites lubricantes, ceras,
                                       y asfalto para pavimentar calles)

  [ <--- ENTRADA DE VAPOR DE PETRÓLEO CRUDO (400 °C) ]
```

A medida que los vapores suben por la torre, se van enfriando. Cuando una molécula de 8 carbonos (octano) sube y llega a una zona de la torre que está a 125 °C, pierde energía, se condensa (se vuelve líquida) y cae en unas bandejas recolectoras. Las moléculas más ligeras (como el propano) siguen subiendo porque 125 °C es mucho calor para ellas y siguen siendo gas. Así, en cada piso de la torre, se extrae una "fracción" diferente del petróleo.

Una vez separadas las fracciones, la industria química toma los hidrocarburos más pesados y baratos y utiliza un proceso llamado **Cracking** (ruptura) térmico o catalítico. Literalmente "rompen" térmicamente las cadenas largas e inútiles de alcanos para convertirlas en cadenas cortas de alcanos (valiosa gasolina) y alquenos (valiosísimo eteno y propeno para hacer plásticos). Los alquenos rara vez se encuentran libres en la naturaleza en grandes cantidades porque son muy reactivos; debemos fabricarlos a partir de los alcanos del petróleo.

## Conclusión: Más allá de una simple cadena

La historia de los alcanos, alquenos y alquinos es, en muchos sentidos, la historia de la civilización moderna. El metano calienta nuestras cenas, el octano acorta las distancias geográficas, el eteno encapsula y preserva nuestros alimentos y medicinas, y el acetileno forja las estructuras metálicas de nuestros puentes y rascacielos.
